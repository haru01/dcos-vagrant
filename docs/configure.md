...
For more information about how the DC/OS installation works and how to debug deployment/installation failure, see [DC/OS Install Process](./dcos-install-process.md).
...
- `DCOS_INSTALL_METHOD` - One of the following [installation methods](./alternate-install-methods.md) (default: `ssh_pull`):
